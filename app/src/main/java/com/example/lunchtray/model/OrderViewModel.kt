...
class OrderViewModel : ViewModel() {
    ...
    fun setEntree(entree: String) {
        ...
        _subtotal.value = _subtotal.value?.plus(_entree.value?.price ?: 0.0)
    }
    ...
    fun setSide(side: String) {
        ...
        _subtotal.value = _subtotal.value?.plus(_side.value?.price ?: 0.0)
    }
    ...
    fun setAccompaniment(accompaniment: String) {
        ...
        _subtotal.value = _subtotal.value?.plus(_accompaniment.value?.price ?: 0.0)
    }
     ...
     */
    fun resetOrder() {
        // clear all previous order prices
        previousEntreePrice = 0.0
        previousSidePrice = 0.0
        previousAccompanimentPrice = 0.0
        // set all previously selected menus to nil
        _entree.value = null
        _side.value = null
        _accompaniment.value = null
        // clear all previously evaluated money
        _subtotal.value = 0.0
        _tax.value = 0.0
        _total.value = 0.0
    }
