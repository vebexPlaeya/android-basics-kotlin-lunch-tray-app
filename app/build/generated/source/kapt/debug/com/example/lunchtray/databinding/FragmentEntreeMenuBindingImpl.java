...
public class FragmentEntreeMenuBindingImpl extends FragmentEntreeMenuBinding implements com.example.lunchtray.generated.callback.OnClickListener.Listener {
    ...
    protected void executeBindings() {
        ...
        boolean viewModelEntreeViewModelMenuItemsPasta = false;
        ...
        boolean viewModelEntreeViewModelMenuItemsSkillet = false;
        ...
        boolean viewModelEntreeViewModelMenuItemsChili = false;
        ...
        boolean viewModelEntreeViewModelMenuItemsCauliflower = false;
        ...
        if ((dirtyFlags & 0x1bL) != 0) {
            ...
            if ((dirtyFlags & 0x1aL) != 0) {
                ...
                if ((dirtyFlags & 0x18L) != 0) {
                    ...
                    // read viewModel.entree.getValue() == viewModel.menuItems["pasta"]
                    viewModelEntreeViewModelMenuItemsPasta = (viewModelEntreeGetValue) == (viewModelMenuItemsPasta);
                    // read viewModel.entree.getValue() == viewModel.menuItems["skillet"]
                    viewModelEntreeViewModelMenuItemsSkillet = (viewModelEntreeGetValue) == (viewModelMenuItemsSkillet);
                    // read viewModel.entree.getValue() == viewModel.menuItems["chili"]
                    viewModelEntreeViewModelMenuItemsChili = (viewModelEntreeGetValue) == (viewModelMenuItemsChili);
                    // read viewModel.entree.getValue() == viewModel.menuItems["cauliflower"]
                    viewModelEntreeViewModelMenuItemsCauliflower = (viewModelEntreeGetValue) == (viewModelMenuItemsCauliflower);
            }
        }
        // batch finished
        ...
        if ((dirtyFlags & 0x1aL) != 0) {
            ...
            androidx.databinding.adapters.CompoundButtonBindingAdapter.setChecked(this.cauliflower, viewModelEntreeViewModelMenuItemsCauliflower);
            androidx.databinding.adapters.CompoundButtonBindingAdapter.setChecked(this.chili, viewModelEntreeViewModelMenuItemsChili);
            androidx.databinding.adapters.CompoundButtonBindingAdapter.setChecked(this.pasta, viewModelEntreeViewModelMenuItemsPasta);
            androidx.databinding.adapters.CompoundButtonBindingAdapter.setChecked(this.skillet, viewModelEntreeViewModelMenuItemsSkillet);
        }
        if ((dirtyFlags & 0x18L) != 0) {
            // api target 1
