...
public class FragmentAccompanimentMenuBindingImpl extends FragmentAccompanimentMenuBinding implements com.example.lunchtray.generated.callback.OnClickListener.Listener {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.accompainmentMenuFragment == variableId) {
            setAccompainmentMenuFragment((com.example.lunchtray.ui.order.AccompanimentMenuFragment) variable);
        }
    ...
    public void setAccompainmentMenuFragment(@Nullable com.example.lunchtray.ui.order.AccompanimentMenuFragment AccompainmentMenuFragment) {
        this.mAccompainmentMenuFragment = AccompainmentMenuFragment;
        synchronized(this) {
            mDirtyFlags |= 0x4L;
        }
        notifyPropertyChanged(BR.accompainmentMenuFragment);
        super.requestRebind();
    }
    ...
    protected void executeBindings() {
        ...
        com.example.lunchtray.ui.order.AccompanimentMenuFragment accompainmentMenuFragment = mAccompainmentMenuFragment;
    ...
    public final void _internalCallbackOnClick(int sourceId , android.view.View callbackArg_0) {
        switch(sourceId) {
            case 4: {
                ...
                // accompainmentMenuFragment != null
                boolean accompainmentMenuFragmentJavaLangObjectNull = false;
                // accompainmentMenuFragment
                com.example.lunchtray.ui.order.AccompanimentMenuFragment accompainmentMenuFragment = mAccompainmentMenuFragment;



                accompainmentMenuFragmentJavaLangObjectNull = (accompainmentMenuFragment) != (null);
                if (accompainmentMenuFragmentJavaLangObjectNull) {


                    accompainmentMenuFragment.cancelOrder();
                }
                break;
            }
            case 2: {
            ...
            case 5: {
                ...
                if (accompainmentMenuFragmentJavaLangObjectNull) {
                    ...
                    accompainmentMenuFragment.goToNextScreen();
                }
                break;
            }
            case 3: {
    ...
    /* flag mapping
        ...
        flag 2 (0x3L): accompainmentMenuFragment
